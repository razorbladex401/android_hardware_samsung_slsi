            ...
            if (exynosInputPort->bStoreMetaData == OMX_TRUE) {
                ...
                if (inputUseBuffer->dataLen <= 0) {
                    if (!(inputUseBuffer->nFlags & OMX_BUFFERFLAG_EOS)) {
                        ...
                        srcInputData->buffer.multiPlaneBuffer.dataBuffer[0] =
                            (void *)Exynos_OSAL_SharedMemory_Alloc(pVideoEnc->hSharedMemory, allocSize[0], NORMAL_MEMORY);
                        srcInputData->buffer.multiPlaneBuffer.fd[0] =
                            Exynos_OSAL_SharedMemory_VirtToION(pVideoEnc->hSharedMemory, srcInputData->buffer.multiPlaneBuffer.dataBuffer[0]);
                        /*Alloc C-Buffer */
                        allocSize[1] = nFrameWidth * nFrameHeight >> 1;
                        srcInputData->buffer.multiPlaneBuffer.dataBuffer[1] =
                            (void *)Exynos_OSAL_SharedMemory_Alloc(pVideoEnc->hSharedMemory, allocSize[1], NORMAL_MEMORY);
                        srcInputData->buffer.multiPlaneBuffer.fd[1] =
                            Exynos_OSAL_SharedMemory_VirtToION(pVideoEnc->hSharedMemory, srcInputData->buffer.multiPlaneBuffer.dataBuffer[1]);
                    ...
                    if (eColorFormat == OMX_COLOR_FormatAndroidOpaque) {
                        ...
                        srcInputData->buffer.multiPlaneBuffer.dataBuffer[0] = planes[0].addr;
                        srcInputData->buffer.multiPlaneBuffer.dataBuffer[1] = planes[1].addr;
                    } else {
